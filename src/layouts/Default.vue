<template>
  <div>
    <section
      class="page-header"
      :style="'background-image: linear-gradient(120deg, '+$static.metadata.backgroundColorLeft+', '+$static.metadata.backgroundColorRight+');color: '+$static.metadata.fontColor+';'"
    >
      ...
      <a :href="'https://github.com/'+$static.metadata.githubUsername" class="btn" target="_blank">GitHub主页</a>
      <a href="https://github.com/GitHub-Laziji/vblog" class="btn" target="_blank" v-if="!$static.metadata.mini">博客源码</a>
    </section>
        ...
        <el-row>
          <el-col :span="10">
            ...
            >
              ...
              <el-submenu index="#webSites" v-if="$static.metadata.webSites.length>0">
                <template slot="title">其他网站</template>
                <el-menu-item
                  :index="'#webSites-'+index"
                  v-for="(item,index) in $static.metadata.webSites"
                  :key="'#webSites'+index"
          ...
          <el-col :span="8" style="text-align: center;padding: 12px 0px 0px 10px">
            ...
            <audio ref="music" loop autoplay v-if="$static.metadata.audioAutoPlay">
              <source :src="$static.metadata.audioUrl" type="audio/mpeg" />
            </audio>
          ...
          <el-col :span="4" style="text-align: right;">
            ...
            <div style="color:#606266;">
              ...
              &nbsp;{{$static.metadata.location?$static.metadata.location:'未填写地址'}}
              <br />
            </div>
          </el-col>
          <el-col :span="2" style="text-align: center;">
            ...
            >
              ...
              &emsp;{{$static.metadata.webSites.name}}
              <br />
              <i class="el-icon-location"></i>
              &emsp;{{$static.metadata.location}}
              <br />
              <img :src="$static.metadata.avatarUrl" style="width: 200px;height: 200px;" />
            </el-popover>
          </el-col>
        </el-row>
      </el-card>
